...
describe('profileService', () => {
    ...
    describe('getProfileByUserId', () => {
        it('returns default candidate profile when none exists', async () => {
            ...
            const result = await (0, profile_service_1.getProfileByUserId)('user-1');
    ...
    describe('upsertCandidateProfile', () => {
        it('updates candidate profile and emits event', async () => {
            ...
            const result = await (0, profile_service_1.upsertCandidateProfile)({
                userId: 'user-1',
                actorId: 'user-1',
                payload: {
                    fullName: 'New Name',
            ...
            expect(publishUserProfileUpdatedEventMock).toHaveBeenCalledWith(expect.objectContaining({
                userId: 'user-1',
                role: 'CANDIDATE',
        ...
        it('throws when candidate is not active', async () => {
            ...
            await expect((0, profile_service_1.upsertCandidateProfile)({
                userId: 'user-1',
                actorId: 'user-1',
                payload: {
                    fullName: 'Name',
                },
            })).rejects.toBeInstanceOf(errors_1.ForbiddenError);
            expect(publishUserProfileUpdatedEventMock).not.toHaveBeenCalled();
        });
    });
    describe('upsertEmployerProfile', () => {
        it('throws when employer is not approved', async () => {
            ...
            await expect((0, profile_service_1.upsertEmployerProfile)({
                userId: 'user-2',
                actorId: 'admin-1',
                payload: {
        ...
        it('publishes event for employer profile changes', async () => {
            ...
            const result = await (0, profile_service_1.upsertEmployerProfile)({
                userId: 'user-2',
                actorId: 'admin-1',
                payload: {
                    companyName: 'Acme Inc',
